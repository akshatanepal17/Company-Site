                        ...
                        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md transform transition-all relative">
                            ...
                            <form onSubmit={handleSubmit} className="p-6 space-y-5">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <input onChange={(e) => setTitle(e.target.value)} value={title} type="text" placeholder="Enter your blog title" className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#1d283a] focus:ring-2 focus:ring-[#1d283a]/20 outline-none transition-all duration-200 bg-white" required />         
                                </div>

                                {/* Content Field - Changed to textarea for better UX */}
                                <div className="space-y-1.5">
                                    <label className="block text-sm font-semibold text-gray-700">
                                        Content <span className="text-red-500">*</span>
                                    </label>
                                    <textarea onChange={(e) => setContent(e.target.value)} value={content} placeholder="Write your blog content here..."rows="5"
                                        className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#1d283a] focus:ring-2 focus:ring-[#1d283a]/20 outline-none transition-all duration-200 bg-white resize-none" required />
                                </div>

                                {/* File Upload - Fixed to work properly */}
                                <div className="space-y-1.5">
                                    <label className="block text-sm font-semibold text-gray-700">
                                        Featured Image
                                    </label>
                                    <div className="relative">
                                        <input onChange={(e) => setImage(e.target.files[0])} type="file" className="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" id="file-upload" />
                                ...
                                <div className="flex gap-3 pt-4">
                                    <button type="submit" className="flex-1 px-6 py-3 bg-[#1d283a] text-white font-semibold rounded-xl hover:bg-[#2a3a4f] transform hover:scale-[1.01] transition-all duration-200 shadow-lg shadow-[#1d283a]/20 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        Publish Blog
                                    </button>
                ...
                <div className="bg-white rounded-xl border border-[#1d283a]/10">
                    <div className="px-6 py-4 border-b border-gray flex item-center justify-between bg-white">
                        ...
                        <div className='flex gap-2'>
                            ...
                            <button onClick={() => setFormOpen(true)} className="inline-flex item-center rounded-full bg-[#1d283a] px-3 py-1 text-xs font-bold uppercase tracking-wider text-white">
                                <span className="material-symbols-outlined text-[18px]">add</span>Add Blog
                            </button>
                        </div>
                    </div>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                    ...
                                    <td className="px-6 py-5">
                                        <div className="flex item-center gap-3">
                                            <div className="size-6 rounded-full overflow-hidden bg-gray-100">
                                                <img className="w-full h-full object-cover" data-alt="Modern UI Design interface screenshot" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBb442EPWZ_Xgj72HShM-E1MblIP-erF6B0bT3OHnPsEBa5fIbqCW5w_WuRF9wRnHFxKgaVEf_P0D9o9bqb_1QZBGq1YYQKcGl53UaBn06HIZs4vSjFEpnL9Kx0a-gvE8sQUj_vpmI-GfuxTHIDK_t3_K4yYr19mO5-Q8VwV_r4z2MCpOCX2mMrD-BOlxeM9RQDWG3dDf1zgUiPdRHUvl2QWLiGnsB-vJQ3gHizzydZdrSxl0Ouz70foVjY09fOAjDVT_qq-gx_ZiQ" />
                                            </div>
                                ...
                                <tr className="hover:bg-gray-50 transition-colors">
                                    <td className="px-6 py-5">
                                        <div className="flex item-center gap-3">
                                            <div className="size-10 rounded-lg overflow-hidden bg-gray-100">
                                                <img className="w-full h-full object-cover" data-alt="UX tips illustration on desk" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAvh8HTB3Eqih647HW1nrv_T5-DIzq0nwjBDz3t9KbBoHcX0J3hGAZHje9QfTt-c0OQ9LkQlh79UPdyqrywSaBkqCpu0u-ulZvFC-rHCCGptYgpyE6mqtItHVhtdCBEfE__AODXjGsosCOVzX087xZciVLdLVtnyYFyL62IPxyi7qXePQAs7LB1MQ5w5WTa2rP3xEgpVcxd-JuNDGOPay3twfBpL7q-QnyfO1YGP7bcBznnI4N_9Yb16TFo6YfV2k3QzgJ_IYTBdug" />
                                            </div>
                                            <div>
                                                <p className="text-sm font-semibold text-primary truncate max-w-[300px]">
                                    ...
                                    <td className="px-6 py-5">
                                        <div className="flex item-center gap-3">
                                            <div className="size-6 rounded-full overflow-hidden bg-gray-100">
                                                <img className="w-full h-full" data-alt="Author profile John Smith" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA-S6rkhwlL-cz212dbGtx8Z1o2sYpbqBtp2YA4cB7c0Ym-oEmHfSGXjRM0PgUgtumfTRq8PfLPutGi-q7K5aJQO4APS4ZG3DYr5G_wMackHiE0UIwz4fwE2WWRAMf8bGER9YiequoQ_mp83iRXr6cnc76KRT3gf_D6etNto603mBFDaWdjgbgMuICiV-3OagbI8UJKepoMbBJFHziz0DILXIeMIzQWR3WIJStflJEsYlZoFyVV8RcQ_9ieI7xzorUQFqhVPHzJvxo" />
                                            </div>
                                ...
                                <tr className="hover:bg-gray-50 transition-colors">
                                    <td className="px-6 py-5">
                                        <div className="flex item-center gap-3">
                                            <div className="size-10 rounded-lg overflow-hidden bg-gray-100">
                                                <img className="w-full h-full object-cover" data-alt="Abstract AI neural network visualization" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBI-y-C5fWw3oU_94DG2LGmVRBjajbCtTvgU_QIRRRXJSHwXBeCofSa8VGxC14MBW6HfcTDjQNksfInziuk0pQ9hIklb4C7-Cju1bjdh8ESXIbSCEv6a6Z0yRA4F2gsy8nl2XYHEWUH7hHgK_aMahCZ1-mNhRBN6JbzDsjAOnFuKnYZptBBfcbn9hv3TrmKud9zRpNT31wlGSlbeLA9AWDmUKycUyxjIqcukAIRE3zjx6LbgTopPIyH-zOZk4eXbXQEjOAI1YnC9qg" />
                                            </div>
                                            <div>
                                                <p className="text-sm font-semibold text-primary truncate max-w-[300px]">
                                    ...
                                    <td className="px-6 py-5">
                                        <div className="flex item-center gap-3">
                                            <div className="size-6 rounded-full overflow-hidden bg-gray-100">
                                                <img className="w-full h-full" data-alt="Author profile Alice Wong" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDxVl4ouK4g9llkoQA7TFy0NShON2HnsxQ96nbiWW67SLSrnbHyHI8VBD-lRvGuXdit_hFUaz5Hco9YazZsVyMbGEfioH7FW2xHU710gTPCkvEVL7R_jGZSA-JkfGHVdDeqZJIhymISKMa4O2o6p8jGO35oiSMBIvPsNqszvVGVQzB6RnxXap_q8wtYmyftlgxLQvhhg_kMR5Fm1GhCalorLoAlBw_Pvrk279Jtf3oR04-oqy5D9p_qGspe8BhuOeRSp9tQmOn5Tzc" />
                                            </div>
